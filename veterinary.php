...
<body>
  ...
  <div class="nav-categories">
    <ul class="nav-cat">
      ...
      <li><a href="veterinary" class="active">Veterinary</a></li>
    </ul>
  </div>
  ...
  <div class="products">
    ...
    <section class="veterinary" id="veterinary">
      <h2>VETERINARY</h2>
      <div class="row1">
        <div class="products-col">
          <div class="image">
            <img src="Products/Veterinary/Product1.png" alt="Product 1" />
            <div class="check-out">
        ...
        <div class="products-col">
          <div class="image">
            <img src="Products/Veterinary/Product2.png" alt="Product 2" />
            <div class="check-out">
              <button onclick="location='https://www.lazada.com.ph/shop/mcragriventurecorporation'">Lazada</button>
              <button onclick="location='https://shopee.ph/mcragriventure'">Shoppe</button>
            </div>
      ...
      <div class="row1">
        <div class="products-col">
          <div class="image">
            <img src="Products/Veterinary/Product3.png" alt="Product 3" />
            <div class="check-out">
            <button onclick="location='https://www.lazada.com.ph/shop/mcragriventurecorporation'">Lazada</button>
              <button onclick="location='https://shopee.ph/mcragriventure'">Shoppe</button>
            </div>
        ...
        <div class="products-col">
          <div class="image">
            <img src="Products/Veterinary/Product4.png" alt="Product 4" />
            <div class="check-out">
             <button onclick="location='https://www.lazada.com.ph/shop/mcragriventurecorporation'">Lazada</button>
              <button onclick="location='https://shopee.ph/mcragriventure'">Shoppe</button>
            </div>
