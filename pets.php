...
<body>
  ...
  <div class="nav-categories">
    <ul class="nav-cat">
      ...
      <li><a href="pets" class="active">Pets</a></li>
    ...
    <section class="pets" id="pets">
      ...
      <div class="row1">
        <div class="products-col">
          <div class="image">
            <img src="Products/Pets/Super%20Nova%20Fish%20Food%2020g.png" alt="Super Nova Fish Food 20g" />
            <div class="check-out">
          ...
          <div class="desc">
            <h3>Super Nova Fish Food 20g</h3>
          </div>
        </div>
        <div class="products-col">
          <div class="image">
            <img src="Products/Pets/Super%20Nova%20Fish%20Food%20100g.png" alt="Super Nova Fish Food 100g" />
            <div class="check-out">
           <button onclick="location='https://www.lazada.com.ph/shop/mcragriventurecorporation'">Lazada</button>
              <button onclick="location='https://shopee.ph/mcragriventure'">Shoppe</button>
            </div>
          ...
          <div class="desc">
            <h3>Super Nova Fish Food 100g</h3>
          </div>
        </div>
      </div>
      <div class="row1">
        <div class="products-col">
          <div class="image">
            <img src="Products/Pets/Super%20Nova%20Fish%20Food%20200g.png" alt="Super Nova Fish Food 200g" />
            <div class="check-out">
            <button onclick="location='https://www.lazada.com.ph/shop/mcragriventurecorporation'">Lazada</button>
              <button onclick="location='https://shopee.ph/mcragriventure'">Shoppe</button>
            </div>
          ...
          <div class="desc">
            <h3>Super Nova Fish Food 200g</h3>
          </div>
        </div>
      </div>
    </section>
