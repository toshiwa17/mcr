...
<body>
  ...
  <div class="nav-categories">
    <ul class="nav-cat">
      ...
      <li><a href="garden-equipment" class="active">Garden Equipments</a></li>
  ...
  <div class="products">
    ...
    <section class="garden" id="garden">
      <h2>GARDEN EQUIPMENTS</h2>
      <div class="row1">
        <div class="products-col">
          <div class="image">
            <img src="Products/Garden/Osmocote%20250grams.png" alt="Osmocote 250g" />
            <div class="check-out">
        ...
        <div class="products-col">
          <div class="image">
            <img src="Products/Garden/Osmocote%201kg.png" alt="Osmocote 1kg" />
            <div class="check-out">
              <button onclick="location='https://www.lazada.com.ph/shop/mcragriventurecorporation'">Lazada</button>
              <button onclick="location='https://shopee.ph/mcragriventure'">Shoppe</button>
            </div>
      ...
      <div class="row1">
        <div class="products-col">
          <div class="image">
            <img src="Products/Garden/Osmocote%20kg.png" alt="Osmocote 3.6kg" />
            <div class="check-out">
             <button onclick="location='https://www.lazada.com.ph/shop/mcragriventurecorporation'">Lazada</button>
              <button onclick="location='https://shopee.ph/mcragriventure'">Shoppe</button>
            </div>
